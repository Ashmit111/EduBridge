...
const mentors = [
  {
    ...
    bio: "Experienced React developer with 10+ years in the industry.",
    experience: "10+ years",
    availability: "Mon-Fri, 9AM-5PM",
    expertise: ["React", "Redux", "Node.js"],
  },
  {
    id: 2,
    name: "Namo Prajapati",
    ...
    bio: "Passionate UI/UX designer with a keen eye for detail.",
    experience: "8 years",
  ...
  },
  {
    ...
    bio: "Python enthusiast specializing in data science and machine learning.",
    experience: "6 years",
...
const ContentDashBoard = () => {
  ...
  const NavigateUserToBook = () => {
    navigate("/dashboard/bookschedule");
  };
